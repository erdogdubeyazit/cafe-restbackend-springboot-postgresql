...
public class BeverageControllerTest {
    ...
    public void testGetAll_should_fail_withoutAuthentication() throws Exception {
        MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders.get("/api/beverages");
    ...
    public void create_with_ROLE_USER_should_fail() throws Exception {
        BeveragePayload payload = new BeveragePayload();
        ...
        MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders.post("/api/beverages")
    ...
    public void update_with_ROLE_USER_should_fail() throws Exception {
        ...
        MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders.patch("/api/beverages/1")
                .contentType(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(payload));
    ...
    public void update_with_wrong_method_should_fail() throws Exception {
        ...
        MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders.post("/api/beverages/1")
                .contentType(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(payload));
    ...
    public void delete_with_ROLE_USER_should_fail() throws Exception {
        MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders.delete("/api/beverages/1");
